...
<script setup>
  ...
  import { nameRequiredRule, emailRequiredRule, passwordRule, confirmPasswordRule, checkRule } from '@/composables/validationRules';
  ...
  const checkLoginValidation = computed(() => {
    ...
    return emailValid.valid && passwordValid.valid && nameValid && confirmPasswordValid;
  })
